  ...
  <div class="container-fluid">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary">Cahaya</span>Aksara</h2>
          <p class="mb-4">"Membaca buku adalah investasi terbaik untuk masa depan: <br> Perpustakaan Online <span class="fw-bold">CahayaAksara</span> Membawa Anda ke Dunia Buku Digital."</p>
          <a class="btn btn-primary" href="sign/link_login.html">Get started</a>
        </div>
        <div class="col mt-3">
          <img src="assets/logoDashboard-transformed.jpg" width="450px">
        </div>
      </div>
    </section>
    ...
    <section class="bg-body-secondary p-5" id="aboutSection">
      <div class="row">
        ...
        pengguna, fitur pencarian canggih, dan koleksi konten yang terus berkembang untuk menginspirasi dan memberdayakan semua anggota Relawan kami</p>
      </div>
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">TBM Cahaya Aksara</div>
        <div class="card-body">
          <h5 class="card-title">Relawan Cahaya Aksara</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        <div class="col mt-3">
          ...
          <p class="text-secondary fs-6">Kp.Curug Luhur Cikondang RT/RW 004/006, Waringinjaya, Cigeulis, Kabupaten Pandeglang, Banten 42282</p>
        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width <a href="" class="text-decoration-none">Visual Studio Code</a>  2024</p>
        </div>
      </div>
    </footer>
